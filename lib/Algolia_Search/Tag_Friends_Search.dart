...
class TagFriendsSearch extends StatefulWidget {
  final String uid;
  TagFriendsSearch({Key key, this.uid}) : super(key: key);

  @override
  _TagFriendsSearchState createState() => _TagFriendsSearchState();
}

class _TagFriendsSearchState extends State<TagFriendsSearch> {
